...
Note: repository based on [Microservices Architecture and Implementation on .NET 5 course](https://www.udemy.com/course/microservices-architecture-and-implementation-on-dotnet/)
